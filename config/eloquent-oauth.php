...
return [
    ...
    'providers' => [
        'facebook' => [
            ...
            'redirect_uri' => 'http://ec2-52-10-0-44.us-west-2.compute.amazonaws.com/facebook/callback',
            'scope' => [],
        ],
        'google' => [
            'client_id' => '311447366874-kf7um0arh91tt5mk0m6k51poemjudeik.apps.googleusercontent.com',
            'client_secret' => 'zGNZxMM-HAHMzIdCn_qpYMOy',
            'redirect_uri' => 'http://ec2-52-10-0-44.us-west-2.compute.amazonaws.com/google/callback',
            'scope' => [],
        ],
        'github' => [
            'client_id' => 'd892334af06ec30567f3',
            'client_secret' => '0b3d92560552a994d00d3943cca1507fc4f28f64',
            'redirect_uri' => 'http://ec2-52-10-0-44.us-west-2.compute.amazonaws.com/github/callback',
            'scope' => [],
        ],
        'linkedin' => [
            'client_id' => '12345678',
